      ...
      var c = n(8),
        ...
        C = function(t, e) {
          ...
          return function(r, o) {
            if (o = o || function() {}, "getService" !== t && "abortUploadTask" !== t) {
              ...
              if (r.Bucket) {
                if (!/^(.+)-(\d+)$/.test(r.Bucket))
                  if (r.AppId) r.Bucket = r.Bucket + "-" + r.AppId;
                  else {
        ...
        m = function(t, e) {
          ...
          var r, o, i = this,
            ...
            u = Date.now();
          return function(e, r) {
            if (e && (s = e.loaded, t = e.total), r) clearTimeout(o), n();
            else {
              if (o) return;
        ...
        a = r.WordArray = i.extend({
          ...
          concat: function(t) {
            ...
            if (t = t.sigBytes, this.clamp(), r % 4)
              for (var o = 0; o < t; o++) e[r + o >>> 2] |= (n[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 24 - (r + o) % 4 * 8;
            else if (65535 < n.length)
              for (o = 0; o < t; o += 4) e[r + o >>> 2] = n[o >>> 2];
      ...
      o.Base64 = {
        stringify: function(t) {
          ...
          for (var o = [], i = 0; i < n; i += 3)
            for (var a = e[i >>> 2] >>> 24 - i % 4 * 8 & 255, s = e[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255, u = e[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, c = a << 16 | s << 8 | u, l = 0; l < 4 && i + .75 * l < n; l++) o.push(r.charAt(c >>> 6 * (3 - l) & 63));
          var f = r.charAt(64);
          if (f)
    ...
    var n = function(t) {
        ...
        function A(t, e, n, r) {
          ...
          if (0 == t.length) o += l(t, e, n, !0);
            ...
            for (var i = 0; i < t.length; i++) o += l(t[i], e, y(t[i]), !1), o += _(t[i], m(r, e)), o += f(t[i], e);
          return o
        }
            ...
            for (var r in t)
              if (!d(t, r) && ("" == e || g(t, r, m(e, r)))) {
                ...
                if (null == o || void 0 == o) n += l(o, r, i, !0);
                  ...
                  if (o instanceof Array) n += A(o, r, i, e);
                  else if (o instanceof Date) n += l(o, r, i, !1), n += o.toISOString(), n += f(o, r);
                else {
                  var a = p(o);
        ...
        return function t(r, a, s) {
          ...
          switch ((Array.isArray ? Array.isArray(r) : r instanceof Array) ? u = "array" : r instanceof Date && (u = "date"), u) {
            ...
            case "object":
              var l = [];
              for (var f in r)
                if (r[f] instanceof Array)
                  for (var h in r[f]) l.push(o(f, t(r[f][h], 0, s + 1), null, s + 1, i(r[f][h]).length));
            ...
            if (i) {
              ...
              if (a || s || "canceled" === r && "paused" === i.state) {
                ...
                i.state = r, t.emit("inner-kill-task", {
                  TaskId: e
                }), u(), s && (o--, c(t)), "canceled" === r && (delete i.params, delete i.callback)
              }
            }
          };
    ...
    (function(t) {
      ...
      function o(t, e) {
        L.call(this, {
          ...
          var r, o, i;
          if (t)
            if ((i = t.statusCode) && 404 === i) r = !1, o = !1;
            else {
      ...
      function c(t, e) {
        ...
        if (t.AccessControlPolicy) {
          var o = j.clone(t.AccessControlPolicy || {}),
            i = o.Grants || o.Grant;
          i = j.isArray(i) ? i : [i], delete o.Grant, delete o.Grants, o.AccessControlList = {
            Grant: i
          }, r = j.json2xml({
            AccessControlPolicy: o
          }), n["Content-MD5"] = j.binaryBase64(j.md5(r)), n["Content-Type"] = "application/xml"
        }
        L.call(this, {
          method: "PUT",
          Bucket: t.Bucket,
      ...
      function y(t, e) {
        L.call(this, {
          ...
          if (t)
            if (404 !== t.statusCode || !t.error || "Not Found" !== t.error && "NoSuchTagSet" !== t.error.Code) e(t);
            else {
              var r = {
                Tags: [],
                statusCode: t.statusCode
